 ...
 */
@interface DAEDeepArtEffectsClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = DAEDeepArtEffectsClient.defaultClient()

 *Objective-C*

     DAEDeepArtEffectsClient *serviceClient = [DAEDeepArtEffectsClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         DAEDeepArtEffectsClient.registerClientWithConfiguration(configuration, forKey: "USWest2DAEDeepArtEffectsClient")
 ...
 *Swift*
     ...
     let serviceClient = DAEDeepArtEffectsClient(forKey: "USWest2DAEDeepArtEffectsClient")

 *Objective-C*

     DAEDeepArtEffectsClient *serviceClient = [DAEDeepArtEffectsClient clientForKey:@"USWest2DAEDeepArtEffectsClient"];
 ...
 */
- (AWSTask *)resultGet:(nullable NSString *)submissionId;

/**
 
 
 
 return type: DAEEmpty *
 */
